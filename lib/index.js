(function() {
  var addTestData, app, complexQuery, context, db, deleteTestData, express, find, getGroup, getMembers, initData, jsonld, levelgraph, searchLevelGraph, validator;
  ...
  app.get("/groups", function(req, res, next) {
    if (Object.keys(req.query).length > 1) {
      ...
      return find(req.query, callback);
    }
  });
