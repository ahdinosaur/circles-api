...
(function() {
  var Promise, addContext, addDefaultPrefix, addTestData, alias, app, compact, complexQuery, context, create, db, deleteTestData, expand, expandQuery, express, extractPredicateAndObject, find, get, getKey, getMembers, hasType, initData, jsonld, jsonldUtil, levelgraph, pair, urlencode, validator, _;
  ...
  app.put("/groups/:id", function(req, res, next) {
    ...
    id = urlencode.decode(req.params.id);
    body = req.body;
    create(body, null).then(function(obj) {
    ...
    return addDefaultPrefix(terms, context).then(function(terms) {
      ...
      return console.log('putted group', group);
    });
  });
