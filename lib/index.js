(function() {
  var addTestData, app, complexQuery, db, deleteTestData, express, getGroup, getMembers, initData, jsonld, levelgraph, searchLevelGraph, simpleQuery, validator;
  ...
  app.get("/groups/:id/members", function(req, res, next) {
    var id;
    id = validator.isURL(id) ? req.params.id : "http://circles.app.enspiral.com/" + req.params.id;
    return getMembers(res, id, initData[0]["@context"]);
  });
